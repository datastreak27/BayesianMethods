...
-   **Student 1 (**$x_1=4, n_1=5$): $\theta$ \| x \~ $Beta(5, 2)$

-   **Student 2 (**$x_2=8, n_2=10$): $\theta$ \| x \~ $Beta(9, 3)$
...
-   Probability that Student 1's true mastery is greater or equal to Student 2 is 44.65%

#### Scenario 2: Guaranteed Success Rate (100%)

Posterior Distributions for each student

-   **Student 1 (**$x_1=5, n_1=5$): $\theta$ \| x \~ $Beta(6, 1)$

-   **Student 2 (**$x_2=10, n_2=10$): $\theta$ \| x \~ $Beta(11,1)$
...
-   Probability that Student 1's true mastery is greater than or equal to Student 2 is 35.76%, a 8.89% drop from scenario 1.
